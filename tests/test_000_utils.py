...
def test_csv_to_params_01():
    ...
    datetime, server_address, result_msec = Server.csv_to_params(text)
    assert datetime == "20201019133124"
    assert server_address == "10.20.30.1/16"
...
def test_csv_to_params_03():
    ...
    assert server_address == "10.25.30.1/20"
    assert result_msec == Server.Server.TIMEOUT_SYMBOL
...
def test_load_data_01():
    ...
    assert servers["10.20.30.1"].ip_address == ipaddress.IPv4Interface("10.20.30.1/16")
...
def test_load_data_02():
    ...
    assert servers["10.20.30.2"].ip_address == ipaddress.IPv4Interface("10.20.30.2/16")
